...
import com.tencent.sr.rmall.openapi.business.right.TsrRightV2Client;
...
public class RightGetCanelListV2Demo {
    ...
    public static void main(String[] args) throws TsrSdkException {
        ...
        //例如 设置超时时间, 个性化密钥
        TsrRightV2Client rightV2Client = new TsrRightV2Client();
        //组装业务请求参数
        GetcancelListOpenApiRequest request = getRightRequest();
        //发起调用
        HttpResult<RightsListOpenApiResponse> response = rightV2Client.getCancelList(request);
